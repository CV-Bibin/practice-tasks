    ...
    <div style={styles.container}>
      ...
      <div style={styles.layout}>
        ...
        <main style={styles.mainContent}>
          ...
          {activeTab === 'usermanagement' && <div><h2>User Role Management Coming Soon</h2></div>}
        </main>
      </div>
    </div>
  );
...
const styles = {
  ...
  navBtn: { backgroundColor: 'transparent', border: '1px solid #475569', color: 'white', padding: '6px 12px', borderRadius: '4px', cursor: 'pointer' },
  ...
  menuBtn: { width: '100%', textAlign: 'left', backgroundColor: 'transparent', border: 'none', color: '#cbd5e1', padding: '10px 24px', cursor: 'pointer', fontSize: '14px', transition: 'background 0.2s' },
  activeMenuBtn: { width: '100%', textAlign: 'left', backgroundColor: '#334155', border: 'none', color: 'white', padding: '10px 24px', cursor: 'pointer', fontSize: '14px', borderLeft: '4px solid #3b82f6' },
